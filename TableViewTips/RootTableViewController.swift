...
class RootTableViewController: UITableViewController {
    ...
    func createView() {
        ...
        self.tableView!.registerClass(RootTableViewCell.self, forCellReuseIdentifier: "MyCell")
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("MyCell") as! RootTableViewCell

        // Configure the cell...
        cell.titleLabel.text = "Demo -- \(indexPath.row)"
        cell.contentLabel.text = self.contenArray[indexPath.row];
